# Create elevation, rivers, and cities map with transformed crs
...
# Bounds for coord_sf()
# Get bounding box of cities and then extend
st_bbox(cities_proj)
bounds <- st_bbox(cities_proj) + c(-100000, -200000, 100000, 200000)
...
ggsave(paste0("img/elevation-map-", st_crs(cities_proj)$epsg, "-", lubridate::today(), ".png"))
